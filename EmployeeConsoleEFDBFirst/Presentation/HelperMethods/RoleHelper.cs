...
using EmployeeConsoleEFDBFirst.Presentation;
...
public class RoleHelper : IRoleHelper
{
    ...
    public RoleHelper(IRoleService roleManager, IDepartmentHelper departmentHelper, ILocationHelper locationHelper, ILocationService locationManager, IDepartmentService departmentManager)
    {
    ...
    public int ChooseRoleId()
    {
        ...
        while (!roleIdEntered)
        {
            ...
            {
                if (roleManager.IdRoleIdValid(roleId))
                {
                    roleIdEntered = true;
                }
                else
