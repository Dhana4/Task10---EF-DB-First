...
public class EmployeeHelper : IEmployeeHelper
{
    ...
    private readonly IDepartmentService departmentManager;
    public EmployeeHelper(IEmployeeService employeeManager, IRoleHelper roleHelper, IRoleService roleManager, ILocationService locationManager, IDepartmentService departmentManager)
    {
            ...
            if (int.TryParse(Console.ReadLine(), out empId))
            {
                ...
                if (employee != null)
                {
                    ...
                    if (roleIdOption.ToLower()[0] == 'y')
                    {
                        ...
                        {
                            if (int.TryParse(Console.ReadLine(), out roleIdToEdit) && roleManager.IdRoleIdValid(roleIdToEdit))
                            {
    ...
    public void ViewAllEmpInRole()
    {
        ...
        if (int.TryParse(Console.ReadLine(), out int roleId) && roleManager.IdRoleIdValid(roleId))
        {
